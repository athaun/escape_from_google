...
public class SpriteAnimation extends Component {
    ...
    public final HashMap<String, List<Sprite>> animations;
    ...
    public void switchAnimation(boolean instant) {
        ...
        if (instant && currentAnimation != null) {
            switchCalled = true;
    ...
    public void update(float dt) {
        ...
        if (switchCalled) {
            ...
            Sprite sprite = currentAnimations.get(0);
            renderer.setSprite(sprite);
            timeOnSprite = timePerSprite;
        }

        //last sprite and no further repetitions
       else if (currentRepetition == 0 && lastSprite) {
